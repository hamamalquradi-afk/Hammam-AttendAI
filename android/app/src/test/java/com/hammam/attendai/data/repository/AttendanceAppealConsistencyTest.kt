...
class AttendanceAppealConsistencyTest {
    ...
    @Test fun rejectedAppealDoesNotRequireNewStatus() {
        assertEquals(null, AppealConsistencyRules.acceptedStatus(false, null))
    }

    @Test fun acceptedAppealUsesCapturedStatus() {
        assertEquals(FinalAttendanceStatus.PRESENT, AppealConsistencyRules.acceptedStatus(true, FinalAttendanceStatus.PRESENT))
        assertEquals(null, AppealConsistencyRules.acceptedStatus(true, null))
    }
}
