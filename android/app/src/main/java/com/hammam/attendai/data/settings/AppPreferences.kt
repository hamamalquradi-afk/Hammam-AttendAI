...
class AppPreferences(private val context:Context){
    ...
    suspend fun markInitializedWithoutSession(){context.dataStore.edit{it[FIRST_RUN]=true;it.remove(USER_ID);it.remove(ROLE)}}
    suspend fun setLocalSession(userId:String,role:String){context.dataStore.edit{it[USER_ID]=userId;it[ROLE]=role}}
    suspend fun clearLocalSession(){context.dataStore.edit{it.remove(USER_ID);it.remove(ROLE)}}
