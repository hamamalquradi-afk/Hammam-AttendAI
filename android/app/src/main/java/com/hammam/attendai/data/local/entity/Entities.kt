...
@Entity(tableName="sync_entity_metadata", primaryKeys=["entityType","entityId"], indices=[Index("entityType"),Index("updatedAt")]) data class SyncEntityMetadataEntity(val entityType:String,val entityId:String,val localVersion:Long,val firstSeenAt:Long,val updatedAt:Long,val payloadFingerprint:String,val lastSyncedServerVersion:Long?=null)
